...
def test_hello_485(tmpdir):
    """Test insta485generator with "hello_485" input.
    ...
    """
    shutil.copytree(TESTDATA_DIR/"hello_485", tmpdir/"hello_485")
    ...
    # Run insta485generator in tmpdir
    subprocess.run(["insta485generator", "hello_485"], check=True, cwd=tmpdir)

    # Make sure generated files exist with correct filenames
    assert output_dir.exists()
    assert index_path.exists()
